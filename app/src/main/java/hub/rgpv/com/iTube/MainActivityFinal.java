...
//            Log.d("created", "1");
//            View view = LayoutInflater.from(MainActivityFinal.this).inflate(R.layout.entity, null);
...
//            holder.title.setText(SongList.get(position).get("CODEC") + " " + SongList.get(position).get("quality"));
//            holder.itemView.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
//                    holder.checkBox.performClick();
//                    Intent intent = new Intent(MainActivityFinal.this, Downloader.class);
...
//            super.onPreExecute();
//            progressDialog = ProgressDialog.show(MainActivityFinal.this, "Downloading...", "Please wait");
//
//        }
//    }
//
...
//    }
//
//    ArrayList<Map<String, String>> parseShared(String text) {
//
//
...
//        URL url = null;
//        try {
//            url = new URL("https://s.ytimg.com/yts/jsbin/player-en_US-vflCdE8nM/base.js");
...
//                Intent intent = new Intent(MainActivityFinal.this, Downloader.class);
//                intent.putExtra("AUDIO", "");
//                intent.putExtra("VIDEO", "" + SongList.get(1).get("encoded_url"));
//                intent.putExtra("TITLE", "" + title);
//
//                startService(intent);
//
